...
static const char *const yytname[] =
{
  ...
  "EOL", "PLUS", "MINUS", "MULT", "DIV", "$accept", "input", "exp", YY_NULLPTR
};
...
#line 1079 "parser.tab.c"
  ...
  case 5: /* exp: VARIABLE  */
#line 35 "parser.y"
               { (yyval.num) = 0; printf("Variable: %c (default value 0)\n", (yyvsp[0].sym)); }
...
#line 39 "parser.y"
                  { if ((yyvsp[0].num) == 0) { yyerror("Division by zero"); (yyval.num) = 0; } else { (yyval.num) = (yyvsp[-2].num) / (yyvsp[0].num); } }
